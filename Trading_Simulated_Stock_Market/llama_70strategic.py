...
# ? Strategic trader persona setup
chat_history = ["""You are a disciplined and strategic trader, guided by analysis and long-term vision. You approach
...
if __name__ == "__main__":
    ...
    chat_with_llama_70_strategic(user_input)
